...
class IndexController extends Controller
{
	public function Index(){
        ...
        return view('frontend.index',compact('skip_category_0','skip_product_0','skip_category_4','skip_product_4','skip_category_5','skip_product_5','hot_deals','special_offer','new','special_deals'));
	} // End Method 
